...
function checkThreadAvailable() {
  try {
    ...
    const threadSelectors = ['[data-qa="thread_view"]', '.p-thread_view', '[data-qa="thread-messages"]', '.c-virtual_list__scroll_container'];
    ...
    const messageSelectors = ['[data-qa="virtual-list-item"]', '.c-virtual_list__item', '[data-qa="message"]', '.c-message_kit__background'];
    let messages = [];
...
/******/ })()
;
//# sourceMappingURL=content-inject.js.map